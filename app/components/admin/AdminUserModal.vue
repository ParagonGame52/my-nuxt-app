      ...
      <form @submit.prevent="emit('submit')" class="space-y-4 sm:space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            >
              <option value="bronze">🥉 Bronze (1x Points, 0% Discount)</option>
              <option value="silver">🥈 Silver (2x Points, 5% Discount)</option>
              <option value="gold">🥇 Gold (3x Points, 10% Discount)</option>
              <option value="platinum">💎 Platinum (5x Points, 15% Discount)</option>
              <option value="diamond">💎 Diamond (10x Points, 25% Discount)</option>
            </select>
          </div>
          <div>
            <label class="h-6 flex items-center text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-300 mb-1.5">
