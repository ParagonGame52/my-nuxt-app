...
const emit = defineEmits<{
  ...
  (e: 'delete-ticket', id: number): void
      ...
      <div class="flex-1 flex flex-col min-w-0">
        ...
        <template v-else>
          ...
          <div class="px-5 py-3 border-b border-slate-200 dark:border-[#212327] bg-white dark:bg-[#191919] flex items-center gap-3">
            ...
            <button
              @click="emit('delete-ticket', selectedTicket.id)"
              title="ลบตั๋วปัญหานี้"
              class="w-8 h-8 rounded-xl bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-900/60 text-rose-600 dark:text-rose-400 flex items-center justify-center transition flex-shrink-0 cursor-pointer"
            >
