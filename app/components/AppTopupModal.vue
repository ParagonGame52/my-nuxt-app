                  ...
                  <div>
                    ...
                    >
                      ...
                      <div class="text-center">
                        ...
                        <p class="text-xs text-slate-400 mt-1">หรือลากและวางไฟล์ที่นี่ (JPG, PNG, WEBP)</p>
                      </div>
                    </label>
                    <p class="text-[10px] text-slate-400 dark:text-slate-500 mt-2 text-center">
                      กรุณาโอนเงินตามยอดที่ระบุ และแนบรูปภาพสลิปให้ชัดเจน แอดมินจะตรวจสอบและปรับยอดเงินให้ภายใน 5–15 นาที
                    </p>
                  </div>
