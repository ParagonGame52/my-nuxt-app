        ...
        >
          ...
          >
            ...
            <div class="p-5 border-b border-slate-200 dark:border-[#212327] flex items-center justify-between">
              <AppLogo size="sm" linkTo="/" @click="close" />
              <button
                @click="close"
            ...
            <div class="p-4 border-b border-slate-200 dark:border-[#212327] bg-slate-50/70 dark:bg-[#0a0a0a]">
              <template v-if="authStore.isLoggedIn">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-2xl overflow-hidden bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-slate-700 dark:text-white text-sm font-black flex-shrink-0 shadow-sm">
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-1.5 flex-wrap">
                      ...
                      <span
                        ...
                        class="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-400 border border-cyan-500/40 text-[9px] font-black px-1.5 py-0.5 rounded flex items-center gap-0.5"
                      >
                        <Icon name="lucide:gem" class="w-2.5 h-2.5 text-cyan-400 animate-pulse" />
                        <span>Diamond</span>
                      </span>
                      <span v-else-if="authStore.isAdmin" class="bg-indigo-600 text-white text-[9px] font-black px-1.5 py-0.5 rounded">Admin</span>
                    </div>
